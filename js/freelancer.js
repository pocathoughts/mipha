...
var optionsNormal = {
  ...
  var firstScroll = new CountUp(firstNum, 0, 6, 0, 4.5, optionsNormal);

  var secondNum = document.getElementById("second-num");
  var secondScroll = new CountUp(secondNum, 0, 50, true, 4.5, optionsDollar);

  var thirdNum = document.getElementById("third-num");
  var thirdScroll = new CountUp(thirdNum, 0, 150, 0, 4.5, optionsPlus);

  // mobile version
  var firstNumMobile = document.getElementById("first-num-mobile");
  var firstScrollMobile = new CountUp(firstNumMobile, 0, 6, 0, 4.5, optionsNormal);

  var secondNumMobile = document.getElementById("second-num-mobile");
  var secondScrollMobile = new CountUp(secondNumMobile, 0, 50, true, 4.5, optionsDollar);

  var thirdNumMobile = document.getElementById("third-num-mobile");
  var thirdScrollMobile = new CountUp(thirdNumMobile, 0, 150, 0, 4.5, optionsPlus);
